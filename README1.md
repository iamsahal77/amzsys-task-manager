...
- Categories, priorities (Low/Medium/High), due dates with overdue/remaining days.
- Filters, full-text search, sorting by created/priority/due date/title.
- Dashboard progress bar and “done today” metric.
- Dark/Light theme toggle (saved in localStorage).
- Toast notifications and modal confirmations.
- Polished UI: gradient navbar, soft shadows, rounded cards, Bootstrap Icons, subtle button ripple.
